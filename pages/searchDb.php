<?php
 ...
 $search = $_POST['form-search'];
 
 
 $sql = "SELECT * FROM images WHERE name ='$search'";
 ...
 if ($result->num_rows > 0) {
   ...
   while($row = $result->fetch_assoc()) {
     ...
     echo "<a class='nav-link' style='width:300px' href='db/insertFavorite.php?p={$row['id']}&r=desporto'>Favoritos <i class='fa fa-solid fa-heart'></i></a>";
